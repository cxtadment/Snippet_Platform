...
@ComponentScan({ "com.xiaoting.snippet.persistence" })
@PropertySource({ "classpath:persistence-${persistenceTarget:h2}.properties" })
@EnableJpaRepositories(basePackages = "com.xiaoting.snippet.persistence.dao")
public class SnippetPersistenceJpaConfig {
    @Autowired
    private Environment env;

    public SnippetPersistenceJpaConfig() {
        super();
    }
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[] { "com.xiaoting.snippet" });
