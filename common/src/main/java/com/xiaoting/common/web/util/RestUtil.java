package com.xiaoting.common.web.util;

import com.xiaoting.common.web.exception.MyConflictException;
import com.xiaoting.common.web.exception.ValidationException;
...
public final class RestUtil {
     ...
     * - if the response does not have the expected 201 status code, then an exception is thrown
     *
